...
// ── ProfileMenu ───────────────────────────────────────────────────────────────
// Avatar button + dropdown (appearance, reader themes, sign out). Shared by
// TopBar (Admin dashboard) and SidebarNav (Member dashboard) so both surfaces
// stay in sync without duplicating this logic.

function ProfileMenu({ username, avatar, tier, onLogout, wrapperClassName = 'topbar-right' }) {
